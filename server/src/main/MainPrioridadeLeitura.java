...
import concorrencia.ControladorPrioridadeParaLeitura;

public class MainPrioridadeLeitura {
	public static void main(String[] args) {
		try {
			ControladorLeitorEscritor controlador = new ControladorPrioridadeParaLeitura();
			...
			System.out.println("Servidor com prioridade de leitura na porta 1099!");
